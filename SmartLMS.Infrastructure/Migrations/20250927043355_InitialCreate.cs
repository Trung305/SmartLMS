        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Progress = table.Column<decimal>(type: "decimal(5,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstWatchedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CompletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastAccessDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedDate", "Description", "Icon", "IsActive", "Name", "ParentCategoryId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 27, 4, 33, 54, 971, DateTimeKind.Utc).AddTicks(4560), "Các khóa học về lập trình", "fa-code", true, "Lập trình", null },
                    { 2, new DateTime(2025, 9, 27, 4, 33, 54, 971, DateTimeKind.Utc).AddTicks(4565), "Các khóa học về thiết kế", "fa-paint-brush", true, "Thiết kế", null },
                    { 3, new DateTime(2025, 9, 27, 4, 33, 54, 971, DateTimeKind.Utc).AddTicks(4567), "Các khóa học về marketing", "fa-bullhorn", true, "Marketing", null },
                    { 4, new DateTime(2025, 9, 27, 4, 33, 54, 971, DateTimeKind.Utc).AddTicks(4569), "Các khóa học về kinh doanh", "fa-briefcase", true, "Kinh doanh", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_Date",
                table: "Enrollments",
                column: "EnrollmentDate");

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_Student_Course_Unique",
                table: "Enrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_Completion",
                table: "LessonProgress",
                columns: new[] { "EnrollmentId", "IsCompleted" });

            migrationBuilder.CreateIndex(
                name: "IX_LessonProgress_Enrollment_Lesson_Unique",
                table: "LessonProgress",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_Student_Quiz_Attempt",
                table: "QuizAttempts",
